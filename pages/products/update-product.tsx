...
const UpdateProduct: NextPage<ProductProps> = ({
	...
	return (
		...
		>
			<Row>
				<h4 className='text-center productFormHeading'>Registro de Producto</h4>
				<hr />
				<Col>
					<Form>
						...
						<Form.Group controlId='formFile' className='mb-3'>
							<Form.Label>Requerimiento de Producto</Form.Label>
						...
						<div>
							<p style={{ color: '#10557a' }}>Lista de Requerimientos:</p>
				...
				<Col>
					<Form>
						...
						<Form.Group controlId='formBasicEmail'>
							<Form.Label>Producto URL</Form.Label>
							<Form.Control
								type='text'
						...
						<Form.Group controlId='formBasicEmail'>
							<Form.Label>Producto Download URL</Form.Label>
							<Form.Control
								type='text'
						...
						<Form.Group controlId='formBasicEmail'>
							<Form.Label>Productos Destacados</Form.Label>
							<InputGroup className='mb-3'>
								<Form.Control
									type='text'
